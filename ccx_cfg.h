...
static const uint8_t CCx_registers[CCX_NR_OF_REGISTERS] PROGMEM = { CCx_FSCTRL1,
		CCx_FSCTRL0, CCx_FREQ2, CCx_FREQ1, CCx_FREQ0, CCx_MDMCFG4, CCx_MDMCFG3,
		CCx_MDMCFG2, CCx_MDMCFG1, CCx_MDMCFG0, CCx_CHANNR, CCx_DEVIATN,
		CCx_FREND1, CCx_FREND0, CCx_MCSM0, CCx_FOCCFG, CCx_BSCFG, CCx_AGCCTRL2,
		CCx_AGCCTRL1, CCx_AGCCTRL0, CCx_FSCAL3, CCx_FSCAL2, CCx_FSCAL1,
		CCx_FSCAL0, CCx_FSTEST, CCx_TEST2, CCx_TEST1, CCx_TEST0, CCx_FIFOTHR,
		CCx_IOCFG2, CCx_IOCFG0D, CCx_PKTCTRL1, CCx_PKTCTRL0, CCx_ADDR,
		CCx_PKTLEN, };
